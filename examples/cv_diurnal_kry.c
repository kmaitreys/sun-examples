...
// #define PI SUN_RCONST(3.14159265358979323846264338327950288) /* pi */
...
static int jtv(N_Vector v, N_Vector Jv, sunrealtype t, N_Vector y, N_Vector fy, void *user_data, N_Vector tmp);

static int Precond(sunrealtype tn, N_Vector u, N_Vector fu, sunbooleantype jok, sunbooleantype *jcurPtr,
                   sunrealtype gamma, void *user_data);

static int PSolve(sunrealtype tn, N_Vector u, N_Vector fu, N_Vector r, N_Vector z, sunrealtype gamma, sunrealtype delta,
...
static void PrintOutput(void *cvode_mem, N_Vector u, sunrealtype t) {
    ...
    printf("c1 (bot.left/middle/top rt.) = %12.3Le  %12.3Le  %12.3Le\n", IJKth(udata, 1, 0, 0),
           IJKth(udata, 1, mxh, myh), IJKth(udata, 1, mx1, my1));
    printf("c2 (bot.left/middle/top rt.) = %12.3Le  %12.3Le  %12.3Le\n\n", IJKth(udata, 2, 0, 0),
           IJKth(udata, 2, mxh, myh), IJKth(udata, 2, mx1, my1));
...
static int f(sunrealtype t, N_Vector u, N_Vector udot, void *user_data) {
    ...
    for (jy = 0; jy < MY; jy++) {
        ...
        for (jx = 0; jx < MX; jx++) {
            ...
            // printf("cyup = %12.10e, c1up = %12.10e, c1 = %12.10e, cydn = %12.10e, c1dn = %12.10e\n", cyup, c1up, c1,
            //        cydn, c1dn);
            ...
            // printf("vertd1 = %12.6e, hord1 = %12.6e, horad1 = %12.6e, rkin1 = %12.6e\n", vertd1, hord1, horad1,
            // rkin1);
...
static int jtv(N_Vector v, N_Vector Jv, sunrealtype t, N_Vector u, N_Vector fu, void *user_data, N_Vector tmp) {
    sunrealtype c1, c2;
